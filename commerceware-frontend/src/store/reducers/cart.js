const INITIAL_STATE={
  products: {
    "5d0110f5da5b163860cc6cbaXXX": {
      _id:'5d0110f5da5b163860cc6cbaXXX', title:"title", price: 10, promotion:"THREE_BY_10", quantity: 1
    },
    "5d01110bda5b163860cc6cbb": { 
      _id:'5d01110bda5b163860cc6cbb', title:"title2", price: 50, promotion:"THREE_BY_10", quantity: 3
    }
  }
}
  ...
  switch(action.type){
    ...
    case 'REMOVE_CART_ITEM': 
      return state.filter(function( elem, index, array ) {
        return elem.product._id !== action.payload.product._id;
      });
